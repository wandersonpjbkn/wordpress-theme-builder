...
// ==============================================
// Component: Dynamic Section Type #8
// ==============================================
...
<section class="section__large">
  <div class="container grid--1 grid--3@sm">
    ...
    <?php foreach ( $data as $item ) : ?>
      ...
      <!-- set card model -->
      <?php set_query_var( 'card_dynamic_model', 'md--3-long' ) ?>
      ...
      <!-- set card mobile image -->
      <?php set_query_var( 'lazy_image_has_mobile_image', true ); ?>
      <?php set_query_var( 'lazy_image_mobile_image_ID', (int)$item[ 'card_mobile_image' ] ); ?>
