...
<div class="woocommerce-shipping-fields margin__bottom--medium col--1 is__theme--light">

	<?php if ( true === WC()->cart->needs_shipping_address() ) : ?>

		<!-- label shipping different address -->
		...
		<div class="shipping_address">
			...
			<div class="woocommerce-shipping-fields__field-wrapper is__flex">
...
<div class="woocommerce-additional-fields">
	...
	<?php if ( apply_filters( 'woocommerce_enable_order_notes_field', 'yes' === get_option( 'woocommerce_enable_order_comments', 'yes' ) ) ) : ?>
		...
		<div class="woocommerce-additional-fields__field-wrapper is__flex">
